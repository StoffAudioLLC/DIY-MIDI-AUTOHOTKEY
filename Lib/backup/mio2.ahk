...
MidiOut(){
  MidiOutDevice := 12
  OutputDebug, % MidiOutDevice                                                                 ; label to load new settings from midi out menu item
  OpenCloseMidiAPI()
