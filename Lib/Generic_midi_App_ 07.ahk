...
Mididothing(){    	                                                    ; Only run one instance
...
;*************************************************
SentaCC(CC_numAHK, CCIntValAHK){
  Channel = 2
  midiOutShortMsg(h_midiout, (Channel+175), CC_numAHK, CCIntValAHK)
}
SentaNO(parm1, parm2){
  Channel = 2
  midiOutShortMsg(h_midiout, (Channel+127), parm1, parm2)
}
/* 
